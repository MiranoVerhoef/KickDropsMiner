...
- **v2.0.4 quality and cleanup controls** - reapplies selected Kick stream quality after playback loads and adds a Settings action to delete finished drops.
- **v2.0.3 stability patch** - fixes the Logging navigation crash, prevents Python bytecode cache folders from being generated by the bridge, and hardens Chrome restart/autoclaim handling.
